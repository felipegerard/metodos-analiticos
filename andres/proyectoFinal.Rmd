...
A la derecha de la línea roja, están los 15 documentos con los scores más altos. Si la cantidad de documentos cercanos la linea roja por el lado izquierdo es muy grande quiere deicr que no estamos logrando una buena discriminación. Por el contrario, si la distribución tiene una cola muy delgada del lado derecho, realmente estamos obteniendo documentos relevantes.
